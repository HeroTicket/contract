...
// IsIssuer is a free data retrieval call binding the contract method 0x5def14f2.
//
// Solidity: function isIssuer(address ticketAddress, address to) view returns(bool)
func (_Heroticket *HeroticketCaller) IsIssuer(opts *bind.CallOpts, ticketAddress common.Address, to common.Address) (bool, error) {
	var out []interface{}
	err := _Heroticket.contract.Call(opts, &out, "isIssuer", ticketAddress, to)
...
//
// Solidity: function isIssuer(address ticketAddress, address to) view returns(bool)
func (_Heroticket *HeroticketSession) IsIssuer(ticketAddress common.Address, to common.Address) (bool, error) {
	return _Heroticket.Contract.IsIssuer(&_Heroticket.CallOpts, ticketAddress, to)
}

// IsIssuer is a free data retrieval call binding the contract method 0x5def14f2.
//
// Solidity: function isIssuer(address ticketAddress, address to) view returns(bool)
func (_Heroticket *HeroticketCallerSession) IsIssuer(ticketAddress common.Address, to common.Address) (bool, error) {
	return _Heroticket.Contract.IsIssuer(&_Heroticket.CallOpts, ticketAddress, to)
}
