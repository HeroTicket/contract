...
const main = async () => {
  ...
  // const TicketImageConsumer = await deploy('TicketImageConsumer', deployer,
  //   [
  ...
  // console.log('TicketImageConsumer contract address:', TicketImageConsumer.target);

  // const TicketImageConsumer = await ethers.getContractFactory('TicketImageConsumer', deployer);

  // const ticketImageConsumer = TicketImageConsumer.attach("0xE06364a013C37375ebFDDf0fb01C3262Ed385D69");


  // const tx = await ticketImageConsumer.requestTicketImage(process.env.ENCRYPTED_SECRET_URLS, "Seoul", "YOASOBI Concert");

  // console.log(tx);

  const request = await ticketImageConsumer.requests("0xbb8ea11768b3c9106441b9588cc4fbe20915f30b78771cd237bec0e408dafd85");
