...
if (openAiResponse.error) {
    throw Error(openAiResponse.error.message ? openAiResponse.error.message : "openai response error");
}
...
if (ipfsPinResponse.error) {
    throw Error(ipfsPinResponse.error.details ? ipfsPinResponse.error.details : "ipfs pin response error");
}
